Feature: Add bulk concepts to an existing dictionary
  ...
  @dictionary
  Scenario: The user should be able to add a single bulk concept from their preferred source
  ...
  @dictionary
  Scenario: The user should be able to add multiple bulk concepts from their preferred source
    Given the user is on the "Add concepts in bulk from CIEL" page
     When the user enters concept Id "1000"
