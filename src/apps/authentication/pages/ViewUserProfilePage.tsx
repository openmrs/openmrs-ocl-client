...
export const ViewUserProfilePage: React.FC<Props> = ({
  ...
  return (
    <Header title="Your Profile" justifyChildren="space-around">
      <Grid id="viewUserProfilePage" item xs={5} component="div">
        <Paper className="fieldsetParent">
          <fieldset>
            ...
            <UserForm savedValues={userProfile} loading={true} />
          </fieldset>
        </Paper>
      </Grid>
      <Grid item xs={5} container spacing={2}>
        <Grid item xs={12} component="div">
          <UserTokenDetails token={userToken} />
        </Grid>
        <Grid item xs={12} component="div">
          <UserOrganisationDetails orgs={userOrganisations} />
        </Grid>
      </Grid>
    </Header>
  );
