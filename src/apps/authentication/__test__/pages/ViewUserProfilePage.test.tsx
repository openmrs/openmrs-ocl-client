...
type viewUserProfilePageProps = React.ComponentProps<typeof ViewUserProfilePage>;
...
describe('viewUserProfilePage', () => {
    ...
    it('user organisation of the state should match test user organisation', () => {
        expect(mapStateToProps(initialState).userOrganisations).toEqual(testAPIOrgList);
    });
