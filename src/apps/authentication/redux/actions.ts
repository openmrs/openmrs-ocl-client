import { completeAction, createActionThunk, createActionType, indexedAction, startAction } from '../../../redux'
import api from "../api";
import {
    LOGIN_ACTION,
    LOGOUT_ACTION,
...
const getProfileAction = createActionThunk(indexedAction(GET_PROFILE_ACTION), api.getProfile);
const getUserOrgsAction = createActionThunk(indexedAction(GET_USER_ORGS_ACTION), api.getUserOrgs);
