...
describe("ContainerOwnerTabs", () => {
  it('should display all the tabs and on click of "Your Cards" it should open corresponding page', () => {
    ...
    const tabsComponent: HTMLElement | null = container.querySelector(
      "[data-testid='tabs']"
    );
    const yourCardsTab: HTMLElement | null = container.querySelector(
      "[data-testid='tab - 0']"
    );
    const publicCardsTab: HTMLElement | null = container.querySelector(
      "[data-testid='tab - 1']"
    );
    const orgCardsTab: HTMLElement | null = container.querySelector(
      "[data-testid='tab - 2']"
    );
