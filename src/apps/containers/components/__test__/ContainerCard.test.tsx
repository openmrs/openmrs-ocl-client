...
describe('ContainerCard', () => {
    it('should display given shortCode and name and owner and description', () => {
        const {container} = renderUI({
            ...
            owner : "root",
            owner_type:"User",
            description: "A universal system for identifying laboratory and clinical observations.",
        ...
        expect(cardDescription).toHaveTextContent("A universal system for identifying laboratory and clinical observations.");
    });
