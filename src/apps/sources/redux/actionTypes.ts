...
export const RESET_CREATE_SOURCE_ACTION = "sources/create";
export const RESET_EDIT_SOURCE_ACTION = "sources/edit";
export const RETRIEVE_SOURCES_ACTION = "sources/retrieveSources";
export const RETRIEVE_SOURCE_ACTION = "sources/retrieveSource";
export const RETRIEVE_SOURCE_VERSIONS_ACTION =
  "sources/retrieveVersions";
