...
describe('ViewSourcesPage', () => {
    it('should match snapshot and it should have all the child components', () => {
        ...
        const containerOwnerTabsComponent: HTMLElement | null = container.querySelector("[data-testid='tabs']");
        const progressOverlayComponent: HTMLElement | null = container.querySelector("[data-testid='loader-message']");
        const viewSourcesComponent: HTMLElement | null = container.querySelector("[data-testid='cards']");
    ...
    it('should show "Loading" message when loading is true', () => {
        ...
        const loadingOverLay: HTMLElement | null = container.querySelector("[data-testid='loader-message']");
    ...
    it('should not show "Loading" message when loading is false', () => {
        ...
        const loadingOverLay = container.querySelector("[data-testid='loader-message']");
    ...
    it('should display search bar and pagination and "No Sources" message', () => {
        ...
        const sourcesSearch: HTMLElement | null = container.querySelector("[data-testid='searchInput']");
        const viewSources: HTMLElement | null = container.querySelector("[data-testid='cards']");
