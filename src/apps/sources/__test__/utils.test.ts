...
describe( 'getSourceTypeFromPreviousPath', () => {
    ...
    it("should return public sources for /sources/", ()=>{
       expect(getSourceTypeFromPreviousPath('/sources/')).toEqual('Public Sources');
    });

    it("should return your sources for /user/sources/", ()=>{
        expect(getSourceTypeFromPreviousPath('/user/sources/')).toEqual('Your Sources');
    });

    it("should return organisation sources for /user/orgs/sources/", ()=>{
        expect(getSourceTypeFromPreviousPath('/user/orgs/sources/')).toEqual('Your Organisations\' Sources');
    });
