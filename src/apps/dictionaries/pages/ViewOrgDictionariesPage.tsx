...
const mapStateToProps = (state: AppState) => ({
  ...
  dictionaries: state.dictionaries.dictionaries[ORG_DICTIONARIES_ACTION_INDEX]?.items,
  meta: state.dictionaries.dictionaries[ORG_DICTIONARIES_ACTION_INDEX]?.responseMeta
});
