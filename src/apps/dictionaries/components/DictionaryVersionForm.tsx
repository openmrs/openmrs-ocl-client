...
import {
  Button, ButtonGroup, DialogActions, DialogContent, DialogTitle,
  MenuItem,
  Typography
...
const DictionaryVersionSchema = Yup.object().shape<DictionaryVersion>({
  ...
  released: Yup.boolean().required('Choose whether you would like to release this version'),
            ...
            <>
                <Form>
                  ...
                  {!error ? (
                    ...
                    <Typography align="center" color="error" variant="caption" component="div">
                      {error.detail}
                    </Typography>
                  )}
                  <DialogActions>
