...
describe("viewDictionaryPage", () => {
  it("should list down all the props of the state", () => {
    ...
    expect(
      mapStateToProps(currentState).retrieveDictionaryErrors
    ).not.toBeNull();
  });
  ...
  it("should point to correct dispatch action", () => {
    expect(mapDispatchToProps.retrieveDictionaryAndDetails).toBe(
      retrieveDictionaryAndDetailsAction
    );
    expect(mapDispatchToProps.createDictionaryVersion).toBe(
      createDictionaryVersionAction
    );
    expect(mapDispatchToProps.editDictionaryVersion).toBe(
      editDictionaryVersionAction
    );
    expect(mapDispatchToProps.retrieveDictionaryVersions).toBe(
      retrieveDictionaryVersionsAction
    );
  });
});
