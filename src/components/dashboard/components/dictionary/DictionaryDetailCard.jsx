...
const DictionaryDetailCard = (dictionary) => {
  const {
    dictionary: { name, created_on, updated_on, public_access, owner, owner_type, active_concepts, description }
  } = dictionary
        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="col-6" id="rightside-detail">
              ...
              <p class="paragraph">Total Concepts: { active_concepts }</p>
            ...
            <div className="row">
            <div className="card" style={{width: "90%", marginLeft: "4.55%" }}>
            { description ?
              (<div className="card-body">
